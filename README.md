...
Первый запуск(**Когда всё установили**):
    ...
    В обсидиане выбрать пункт открыть папку как хранилище, после выбрать папку где 
    был git init и там выбрать нужный предмет например ваша папка называется
    Hui и вы хотите конспект по информатике тогда открываете Hui и в ней ICT
